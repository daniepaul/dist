...
var ticketNumbers = new schema.Entity('ticketNumbers', undefined, {
  idAttribute: 'number'
});

var tickets = new schema.Entity('tickets', { ticketNumber: ticketNumbers }, {
...
var eligibilities = new schema.Entity('eligibilities', undefined, {
  idAttribute: function idAttribute(value) {
    return get(value, 'reason[0].category', 'NA');
  }
});

var editCodes = new schema.Entity('editCodes');

var airExtras = new schema.Entity('airExtras');

var loyaltyAccounts = new schema.Entity('loyaltyAccounts');

var flights = new schema.Entity('flights');

var boardingPasses = new schema.Entity('boardingPasses', {
...
var passengerFlights = new schema.Entity('passengerFlights', {
  eligibilities: { eligibility: [eligibilities] },
  boardingPass: boardingPasses
});

var passengerSegments = new schema.Entity('passengerSegments', {
  editCodes: {
    editCode: [editCodes]
  },
...
var passports = new schema.Entity('passports', undefined, options);
var nationalIds = new schema.Entity('nationalIds', undefined, options);
// todo: add entity for all document types

var passengerDocuments = new schema.Array({
  passports: passports,
...
var passengers = new schema.Entity('passengers', {
  ticket: [tickets],
  eligibilities: { eligibility: [eligibilities] },
  passengerSegments: {
...
var segments = new schema.Entity('segments', {
  flights: [flights],
  eligibilities: { eligibility: [eligibilities] }
}, {
  processStrategy: function processStrategy(entity) {
...
var itineraryParts = new schema.Entity('itineraries', {
  segment: [segments],
  eligibilities: { eligibility: [eligibilities] },
  airExtra: [airExtras]
});

var reservation = new schema.Entity('reservations', {
...
var index = (function (input) {
  return normalize(input, { reservation: reservation });
});

var seatColumns = new schema.Entity('columns');

var seats = new schema.Entity('seats', undefined, {
  idAttribute: 'number'
});

var seatFacilities = new schema.Entity('facilities', undefined, {
  idAttribute: 'type'
});

var seatSlots = new schema.Entity('slots', {
  seat: seats,
...
var seatRows = new schema.Entity('rows', {
  slot: [seatSlots]
}, {
  idAttribute: 'number'
});

var seatCabins = new schema.Entity('cabins', {
  column: [seatColumns],
  row: [seatRows]
}, {
...
var seatPassengers = new schema.Entity('seatPassengers', {
  passenger: passengers
});

var seatSegments = new schema.Entity('segments');

var seatPrices = new schema.Entity('prices');

var passengerSeatDetail = new schema.Entity('passengerSeatDetails', undefined, {
...
var seatMaps = (function (input) {
  var normalizedOutput = normalize(input, { passengers: { seatMapPassenger: [seatPassengers] } });
  ...
  normalizedOutput.entities.seatMaps = reduce(get(input, 'seatMap'), function (memo, seatMap) {
    if (seatMap) {
      ...
      set(memo, seatMap.id, normalize(seatMap, {
...
export { initialize, availableNormalizers as normalizers, CookingSavingNetworkLink as CookieSavingNetworkLink, index$1 as booking, index$13 as checkin, index$14 as shared };
